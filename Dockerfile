...
# Define o diretório de trabalho como /var/www/html/workspace
WORKDIR /var/www/html/workspace
# Copia o app e altera permissões
COPY ./src /var/www/html/workspace


# Modifica a configuração do DocumentRoot
ENV APACHE_DOCUMENT_ROOT /var/www/html/workspace/public
...
RUN echo '<Directory /var/www/html/workspace/>' >> /etc/apache2/apache2.conf && \
